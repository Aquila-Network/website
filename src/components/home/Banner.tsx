...
const Banner = () => {
	return (
      ...
      <h3 className="text-center text-4xl font-bold mt-10 mb-3">The social hub for niche search engines</h3>
      <p className="text-center">Make your blogs and newsletters discoverable to more people. Works with paywall-protected content.</p>
