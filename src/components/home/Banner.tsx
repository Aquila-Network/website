	...
	return (
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="text-center mt-10">
          ...
          <a href="https://airtable.com/shrhvlKgL6otYCnlb" target="__blank" className="bg-red-500 mr-6 p-3 rounded-full px-5 text-white font-bold transition-colors duration-300 hover:bg-red-600">Sign up with Email</a>
