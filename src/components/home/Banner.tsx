...
const Banner = () => {
	return (
      ...
      <h3 className="text-center text-4xl font-bold mt-10 mb-3">Search first hub for your bookmarks</h3>
      <p className="text-center">let your bookmarks speak for you, while you go down the rabbit hole.</p>
      <div className="text-center mt-8">
        <a href="https://x.aquila.network/explore.html" target="_blank" className="bg-white p-2 mr-4  text-blue-600 underline" rel="noreferrer">Explore bookmarks</a>
