...
const Banner = () => {
	return (
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-center text-gray-700">Build a curated list of websites, aggregate into searchable pool of ideas, <br/>and build a fanbase. Works with paywall-protected websites.</p>
