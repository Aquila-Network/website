...
const Banner = () => {
	return (
      ...
      <div className="flex flex-col justify-center">
        <h3 className="text-center text-5xl font-bold mt-10 mb-4">Search-first hub for your bookmarks</h3>
        ...
        <p className="text-center text-gray-700">Aquila Network allows the entire world to discover your favorite blogs and newsletters.<br/> Spread new ideas, show what you are standing for. Works with paywall-protected websites.</p>
