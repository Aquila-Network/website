...
const PoweredBy = () => {
	return (
		<section className="text-gray-800 font-raleway container m-auto pt-14 pb-14 px-3">
			...
			<p className="text-center mb-20 max-w-screen-sm m-auto">Aquila Network is a set of open protocols to build a decentralized search engine.
				Please read the <a className="text-green-600 font-bold" href="https://github.com/Aquila-Network/specs">technical specifications</a> to learn more in detail.</p>
			<ul className="flex items-center justify-center md:justify-around flex-col md:flex-row">
				...
				<li className="text-center w-80 mb-14 md:mb-0">
					<IonIcon className=" text-9xl mb-5" icon={happyOutline} />
