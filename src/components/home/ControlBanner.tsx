...
const ControlBanner = () => {
	return (
		...
		<div className="w-9/12 md:w-2/4 h-full items-center flex mt-8 md:mt-0">
			...
			<p className="text-gray-800 font-light text-xl mb-5">You're ready to go once you've installed a browser extension. <br/>We're not interested in your personal information. That's why we made our software Open Source for public scrutiny.</p>
